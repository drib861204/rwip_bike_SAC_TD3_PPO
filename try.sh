#!/bin/sh
#0629 TD3 fixed action error, trial 1
...
python3 train.py -trial 1 -seed 0 -type TD3
python3 train.py -trial 1 -seed 1 -type TD3
python3 train.py -trial 1 -seed 2 -type TD3
python3 train.py -trial 1 -seed 3 -type TD3
python3 train.py -trial 1 -seed 4 -type TD3
python3 plot_graph.py -trial 1 -type TD3
python3 test.py -trial 1 -seed 0 -type TD3
python3 test.py -trial 1 -seed 1 -type TD3
python3 test.py -trial 1 -seed 2 -type TD3
python3 test.py -trial 1 -seed 3 -type TD3
python3 test.py -trial 1 -seed 4 -type TD3
